---
name: routewisp-web-fetch
description: Fetch URL → markdown / text / HTML via routewisp /v1/web/fetch using Ollama Cloud / Firecrawl / Jina Reader / Tavily Extract / Exa Contents. Use when the user wants to scrape a webpage, extract URL content, read article, or convert a URL to markdown.
---
